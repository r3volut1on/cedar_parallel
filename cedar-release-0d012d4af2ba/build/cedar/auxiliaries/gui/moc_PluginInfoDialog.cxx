...
static const char qt_meta_stringdata_cedar__aux__gui__PluginInfoDialog[] = {
    "cedar::aux::gui::PluginInfoDialog\0\0"
    "readInfo()\0"
};
...
const QMetaObjectExtraData cedar::aux::gui::PluginInfoDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::PluginInfoDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__PluginInfoDialog,
      qt_meta_data_cedar__aux__gui__PluginInfoDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::PluginInfoDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__PluginInfoDialog))
