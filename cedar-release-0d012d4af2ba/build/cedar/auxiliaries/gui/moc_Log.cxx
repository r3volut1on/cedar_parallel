...
static const char qt_meta_stringdata_cedar__aux__gui__Log[] = {
    "cedar::aux::gui::Log\0\0type,title,message\0"
    "messageReceived(int,QString,QString)\0"
    "point\0showContextMenu(QPoint)\0min,max\0"
    "scrollBarRangeChanged(int,int)\0"
    "printMessage(int,QString,QString)\0"
};
...
const QMetaObjectExtraData cedar::aux::gui::Log::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::Log::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__Log,
      qt_meta_data_cedar__aux__gui__Log, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::Log::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__Log))
