...
static const char qt_meta_stringdata_cedar__aux__gui__EnumParameter[] = {
    "cedar::aux::gui::EnumParameter\0\0"
    "parameterPointerChanged()\0text\0"
    "currentIndexChanged(QString)\0"
    "parameterValueChanged()\0propertiesChanged()\0"
};
...
const QMetaObjectExtraData cedar::aux::gui::EnumParameter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::EnumParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__EnumParameter,
      qt_meta_data_cedar__aux__gui__EnumParameter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::EnumParameter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__EnumParameter))
