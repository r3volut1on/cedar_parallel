...
static const char qt_meta_stringdata_cedar__aux__gui__VelocityParameter[] = {
    "cedar::aux::gui::VelocityParameter\0\0"
    "value\0valueChanged(double)\0"
};
...
const QMetaObjectExtraData cedar::aux::gui::VelocityParameter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::VelocityParameter::staticMetaObject = {
    { &cedar::aux::gui::NumericParameter<cedar::unit::Velocity,QDoubleSpinBox>::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__VelocityParameter,
      qt_meta_data_cedar__aux__gui__VelocityParameter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::VelocityParameter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__VelocityParameter))
        return static_cast<void*>(const_cast< VelocityParameter*>(this));
    typedef cedar::aux::gui::NumericParameter<cedar::unit::Velocity,QDoubleSpinBox> QMocSuperClass;
