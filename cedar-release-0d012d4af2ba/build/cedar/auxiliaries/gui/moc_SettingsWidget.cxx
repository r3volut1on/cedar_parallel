...
static const char qt_meta_stringdata_cedar__aux__gui__SettingsWidget[] = {
    "cedar::aux::gui::SettingsWidget\0\0"
...
const QMetaObjectExtraData cedar::aux::gui::SettingsWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::SettingsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__SettingsWidget,
      qt_meta_data_cedar__aux__gui__SettingsWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::SettingsWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__SettingsWidget))
