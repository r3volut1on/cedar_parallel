...
static const char qt_meta_stringdata_cedar__aux__gui__ResourceDialog[] = {
    "cedar::aux::gui::ResourceDialog\0\0"
    "itemSelected()\0pItem,\0"
...
const QMetaObjectExtraData cedar::aux::gui::ResourceDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::gui::ResourceDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__ResourceDialog,
      qt_meta_data_cedar__aux__gui__ResourceDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::gui::ResourceDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__ResourceDialog))
