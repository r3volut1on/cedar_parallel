...
static const char qt_meta_stringdata_cedar__aux__Settings[] = {
...
const QMetaObjectExtraData cedar::aux::Settings::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::Settings::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__Settings,
      qt_meta_data_cedar__aux__Settings, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::Settings::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__Settings))
