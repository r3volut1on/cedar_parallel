...
static const char qt_meta_stringdata_cedar__aux__conv__Convolution[] = {
    "cedar::aux::conv::Convolution\0\0"
    "configurationChanged()\0selectedEngineChanged()\0"
    "updateCombinedKernel()\0"
};
...
const QMetaObjectExtraData cedar::aux::conv::Convolution::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::conv::Convolution::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__conv__Convolution,
      qt_meta_data_cedar__aux__conv__Convolution, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::conv::Convolution::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__conv__Convolution))
