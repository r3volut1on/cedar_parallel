...
static const char qt_meta_stringdata_cedar__aux__detail__ThreadWorker[] = {
    "cedar::aux::detail::ThreadWorker\0\0"
    "finishedWorking()\0workSlot()\0"
};
...
const QMetaObjectExtraData cedar::aux::detail::ThreadWorker::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::aux::detail::ThreadWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__detail__ThreadWorker,
      qt_meta_data_cedar__aux__detail__ThreadWorker, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::aux::detail::ThreadWorker::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__detail__ThreadWorker))
