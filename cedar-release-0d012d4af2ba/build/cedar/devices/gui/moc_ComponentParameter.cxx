...
static const char qt_meta_stringdata_cedar__dev__gui__ComponentParameter[] = {
    "cedar::dev::gui::ComponentParameter\0"
    "\0openComponentSelector()\0updatePathText()\0"
...
const QMetaObjectExtraData cedar::dev::gui::ComponentParameter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::dev::gui::ComponentParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__dev__gui__ComponentParameter,
      qt_meta_data_cedar__dev__gui__ComponentParameter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::dev::gui::ComponentParameter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dev__gui__ComponentParameter))
