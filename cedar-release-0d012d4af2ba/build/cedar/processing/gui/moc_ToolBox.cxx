...
static const char qt_meta_stringdata_cedar__proc__gui__ToolBox[] = {
    "cedar::proc::gui::ToolBox\0\0data\0"
    "selectionChanged(QString)\0checked\0"
    "toolButtonToggled(bool)\0"
};
...
const QMetaObjectExtraData cedar::proc::gui::ToolBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::proc::gui::ToolBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__ToolBox,
      qt_meta_data_cedar__proc__gui__ToolBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::proc::gui::ToolBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__ToolBox))
