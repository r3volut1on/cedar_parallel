...
static const char qt_meta_stringdata_cedar__proc__gui__BoostControl[] = {
    "cedar::proc::gui::BoostControl\0\0"
    "pItem,column\0itemActivated(QTreeWidgetItem*,int)\0"
};
...
const QMetaObjectExtraData cedar::proc::gui::BoostControl::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::proc::gui::BoostControl::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__BoostControl,
      qt_meta_data_cedar__proc__gui__BoostControl, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::proc::gui::BoostControl::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__BoostControl))
