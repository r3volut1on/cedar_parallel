...
static const char qt_meta_stringdata_cedar__proc__steps__ScalarDivision[] = {
    "cedar::proc::steps::ScalarDivision\0\0"
...
const QMetaObjectExtraData cedar::proc::steps::ScalarDivision::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::proc::steps::ScalarDivision::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__steps__ScalarDivision,
      qt_meta_data_cedar__proc__steps__ScalarDivision, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::proc::steps::ScalarDivision::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__steps__ScalarDivision))
