...
static const char qt_meta_stringdata_cedar__proc__steps__UnitConverter[] = {
    "cedar::proc::steps::UnitConverter\0\0"
    "outputTypeChanged()\0"
};
...
const QMetaObjectExtraData cedar::proc::steps::UnitConverter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject cedar::proc::steps::UnitConverter::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__steps__UnitConverter,
      qt_meta_data_cedar__proc__steps__UnitConverter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &cedar::proc::steps::UnitConverter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__steps__UnitConverter))
