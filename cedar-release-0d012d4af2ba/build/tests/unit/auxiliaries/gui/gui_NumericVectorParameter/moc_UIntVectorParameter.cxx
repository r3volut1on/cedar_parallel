...
static const char qt_meta_stringdata_UIntVectorParameter[] = {
    "UIntVectorParameter\0"
};
...
const QMetaObjectExtraData UIntVectorParameter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UIntVectorParameter::staticMetaObject = {
    { &cedar::aux::gui::UIntVectorParameter::staticMetaObject, qt_meta_stringdata_UIntVectorParameter,
      qt_meta_data_UIntVectorParameter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UIntVectorParameter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UIntVectorParameter))
        return static_cast<void*>(const_cast< UIntVectorParameter*>(this));
    typedef cedar::aux::gui::UIntVectorParameter QMocSuperClass;
